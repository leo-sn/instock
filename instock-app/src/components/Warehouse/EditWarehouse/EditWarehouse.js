        ...
        <div className="warehouse__edit">
          ...
          <div className="edit__flex">
            <div className="warehouse__details">
              <h3 className="warehouse__edit-sub-heading">Warehouse Details</h3>
              <div className="warehouse__edit__label">
                <label className="warehouse__edit__label">Warehouse Name</label>
                <input
              ...
              <div className="warehouse__edit__label">
                <label className="warehouse__edit__label">Street Address</label>
                <input
                  className="warehouse__edit-input"
                  placeholder=""
                  type="text"
              ...
              <div className="warehouse__edit__label">
                <label className="warehouse__edit__label">City</label>
                <input
                  className="warehouse__edit-input"
                  placeholder=""
                  type="text"
              ...
              <div className="warehouse__edit__label">
                <label className="warehouse__edit__label">Country</label>
                <input
                  className="warehouse__edit-input"
                  placeholder=""
                  type="text"
            ...
            <div className="contact__details">
              <h3 className="warehouse__edit-sub-heading">Contact Details</h3>

              <div className="warehouse__edit__label">
                <label className="warehouse__edit__label">Contact Name</label>
                <input
                  className="warehouse__edit-input"
                  placeholder=""
                  type="text"
              ...
              <div className="warehouse__edit__label">
                <label className="warehouse__edit__label">Position</label>
                <input
                  className="warehouse__edit-input"
                  placeholder=""
                  type="text"
              ...
              <div className="warehouse__edit__label">
                <label className="warehouse__edit__label">Phone Number</label>
                <input
                  className="warehouse__edit-input"
                  placeholder=""
                  type="text"
              ...
              <div className="warehouse__edit__label">
                <label className="warehouse__edit__label">Email</label>
                <input
                  className="warehouse__edit-input"
                  placeholder=""
                  type="text"
